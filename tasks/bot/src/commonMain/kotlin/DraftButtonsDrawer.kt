...
import center.sciprog.tasks_bot.courses.common.CoursesDrawer
...
import center.sciprog.tasks_bot.tasks.common.models.tasks.NewTask
...
internal object DraftButtonsDrawer : Plugin {
    ...
    override suspend fun BehaviourContextWithFSM<State>.setupBotPlugin(koin: Koin) {
        ...
        val coursesButtonsDrawer = CoursesDrawer(
            ...
            prefix = "tasks_drafts",
            backButtonData = openDraftWithCourseIdBtnData
        )
        ...
        onMessageDataCallbackQuery(createTaskApproveButtonData) {
            ...
            draft.title ?.let { title ->
                draft.assignmentDateTime ?.let { assignmentDateTime ->
                    if (draft.canBeCreated) {
